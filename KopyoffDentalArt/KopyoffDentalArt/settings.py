"""
Django settings for KopyoffDentalArt project.
...
ALLOWED_HOSTS = ['142.93.64.200', 'www.kopyoffdentalart.com', 'kopyoffdentalart.com']
...
ROOT_URLCONF = 'KopyoffDentalArt.urls'
...
STATIC_ROOT = join_path(BASE_DIR, 'static_root')
