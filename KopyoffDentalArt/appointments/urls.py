...
,delete_absent_appointment, delete_present_appointment, cancel_appointment, delete_block, BookingAdminView
...
urlpatterns = [
    ...
    path('booking_admin/', BookingAdminView.as_view(), name="booking_admin")
]
